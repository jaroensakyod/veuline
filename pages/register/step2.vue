  ...
  methods: {
    ...
    register() {
      if(this.validate()){
        ...
        this.$axios.patch(`https://test-a1626-default-rtdb.asia-southeast1.firebasedatabase.app/line-test-86f08-default-rtdb/data/~2F/members/line:001/profile.json`, this.$store.getters.getRegister).then((res) => {
